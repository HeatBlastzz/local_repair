...
class RepairerEditProfileScreen extends StatefulWidget {
  const RepairerEditProfileScreen({super.key});

  @override
  State<RepairerEditProfileScreen> createState() =>
      _RepairerEditProfileScreenState();
}

class _RepairerEditProfileScreenState extends State<RepairerEditProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Chỉnh Sửa Hồ Sơ Thợ'),
        centerTitle: true,
